...
public class ExtentReportListener implements ITestListener {
	...
	public void configureReport() {
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + ".Webappreports//" + reportName);
		...
		reports.setSystemInfo("user", "Rahul Suryawanshi");

		// configuration
		htmlReporter.config().setDocumentTitle("Automation Testing Report");
		htmlReporter.config().setReportName("Web Automation Testing Report");
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
				System.out.println("I am in WebDriver TC");
//				test.log(Status.FAIL,MarkupHelper.createLabel("Name of the failed test case is" + result.getName(), ExtentColor.RED));
	...
	public String captureScreenshotWebDriver(WebDriver driver) throws IOException {
		...
		String dest = Concat + "./Webappreports/screenshots/" + System.currentTimeMillis() + ".png";
	...
	public void End() throws IOException {
		try {
			Files.move(Paths.get("..//InterviewAssignment.Webappreports//" + reportName),
					Paths.get("..//Webappreports//" + reportName), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			e.printStackTrace();
		}
